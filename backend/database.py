...
class SnowflakeDB:
    """Handles direct Snowflake connection and operations for local development."""
    ...
    def __init__(self) -> None:
        ...
        clean_account = account.replace("https://", "").replace(".snowflakecomputing.com", "")
        self.config = {
        ...
        prod_account = os.getenv("PROD_SNOWFLAKE_ACCOUNT") or account
        self.config_prod = {
            "account": prod_account.replace("https://", "").replace(".snowflakecomputing.com", ""),
            "user": os.getenv("PROD_SNOWFLAKE_USER") or os.getenv("SNOWFLAKE_USER"),
            "password": os.getenv("PROD_SNOWFLAKE_PASSWORD") or os.getenv("SNOWFLAKE_PASSWORD"),
            "database": os.getenv("PROD_SNOWFLAKE_DATABASE"),
            "schema": os.getenv("PROD_SNOWFLAKE_SCHEMA"),
            "warehouse": os.getenv("PROD_SNOWFLAKE_WAREHOUSE") or os.getenv("SNOWFLAKE_WAREHOUSE"),
            "role": os.getenv("PROD_SNOWFLAKE_ROLE") or os.getenv("SNOWFLAKE_ROLE"),
        }

        raw_account = os.getenv("RAW_SNOWFLAKE_ACCOUNT") or account
        self.config_raw = {
            "account": raw_account.replace("https://", "").replace(".snowflakecomputing.com", ""),
            "user": os.getenv("RAW_SNOWFLAKE_USER") or os.getenv("SNOWFLAKE_USER"),
            "password": os.getenv("RAW_SNOWFLAKE_PASSWORD") or os.getenv("SNOWFLAKE_PASSWORD"),
            "database": os.getenv("RAW_SNOWFLAKE_DATABASE"),
            "schema": os.getenv("RAW_SNOWFLAKE_SCHEMA"),
            "warehouse": os.getenv("RAW_SNOWFLAKE_WAREHOUSE") or os.getenv("SNOWFLAKE_WAREHOUSE"),
        ...
        # Assign attributes to PROD config
        ...
        # Assign attributes to RAW config
